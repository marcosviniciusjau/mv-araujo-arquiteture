...
function Company(){
    return (
      <div>
        ...
        <h3> Somos uma renomada
          empresa de arquitetura localizada em Jaú, São Paulo, dedicada a
          transformar ideias e sonhos em realidade por meio de projetos
          arquitetônicos excepcionais. Com um compromisso incansável com a
          ...
          arquitetos talentosos e experientes utiliza tecnologia de ponta e
